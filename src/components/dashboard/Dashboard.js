    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-stats">
        <motion.div className="stat-box" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <h3>
            $<CountUp end={stats.deposits} duration={2} />
          </h3>
          <p>Total Deposits</p>
        </motion.div>
        ...
        <motion.div className="stat-box" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <h3>
            $<CountUp end={stats.withdrawals} duration={2} />
          </h3>
        ...
        <motion.div className="stat-box" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <h3>
            $<CountUp end={stats.investments} duration={2} />
          </h3>
        ...
        <motion.div className="stat-box" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <h3>
            $<CountUp end={stats.earnings} duration={2} />
          </h3>
          <p>Total Earnings</p>
        </motion.div>
      </div>
